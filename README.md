...
1. Who completes offers and who don't? (Logistic Regression)
2. For people responding to different offers, how do their demographic characteristics differ? (Decision Tree Model)
